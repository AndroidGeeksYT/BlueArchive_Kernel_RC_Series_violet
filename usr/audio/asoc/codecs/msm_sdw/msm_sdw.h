...
static __inline__ int msm_sdw_set_spkr_mode(struct snd_soc_codec *codec, int mode)
{
	return 0;
}
static __inline__ int msm_sdw_set_spkr_gain_offset(struct snd_soc_codec *codec,
					int offset)
{
	return 0;
}
